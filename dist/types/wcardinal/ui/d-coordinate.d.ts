 ...
 */
export declare type DCoordinatePosition = number | string | "center" | "padding" | "CENTER" | "PADDING" | DScalarFunction | DScalar;
/**
 * One of the followings:
 * * A size,
 * * A size keywords
 ...
 */
export declare type DCoordinateSize = "auto" | "AUTO" | DCoordinateSizeNoAuto;
export declare type DCoordinateSizeNoAuto = number | string | "100%" | "maximized" | "padding" | "MAXIMIZED" | "PADDING" | DScalarFunction | DScalar;
