...
export declare enum DChartCoordinateDirection {
    X = 0,
    Y = 1
}
export interface DChartCoordinate {
     ...
     */
    ticks(domainMin: number, domainMax: number, majorCount: number, minorCountPerMajor: number, minorCount: number, majorResult: Float64Array, minorResult: Float64Array): void;
}
