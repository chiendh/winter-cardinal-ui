...
export declare enum DTableColumnType {
    INDEX = 0,
    TEXT = 1,
    INTEGER = 2,
    REAL = 3,
...
export declare type DTableGetter<ROW, CELL> = (row: ROW, columnIndex: number) => CELL;
export declare type DTableSetter<ROW, CELL> = (row: ROW, columnIndex: number, cell: CELL) => void;
export declare type DTableFormatter<CELL> = (cell: CELL) => string;
export declare type DTableEditingFormatter<CELL> = (cell: CELL) => string;
export declare type DTableEditingUnformatter<CELL> = (formatted: string) => CELL;
export declare type DTableEditingValidator<CELL> = (cell: CELL) => string | null;
export declare type DTableSelectingGetter<CELL, DIALOG> = (dialog: DIALOG) => CELL;
export declare type DTableSelectingSetter<CELL, DIALOG> = (dialog: DIALOG, cell: CELL) => void;
export declare type DTableEditable<ROW> = (row: ROW, columnIndex: number) => boolean;
export declare type DTableRenderable<ROW> = (row: ROW, columnIndex: number) => boolean;
export declare type DTableBodyCellOptionsUnion<ROW> = DTableBodyCellTextOptions<ROW> | DTableBodyCellInputTextOptions<ROW> | DTableBodyCellInputIntegerOptions<ROW> | DTableBodyCellInputRealOptions<ROW> | DTableBodyCellIndexOptions<ROW> | DTableBodyCellColorOptions<ROW> | DTableBodyCellCheckOptions<ROW> | DTableBodyCellSelectDialogOptions<ROW> | DTableBodyCellSelectPromiseOptions<ROW> | DTableBodyCellSelectMenuOptions<ROW> | DTableBodyCellDateOptions<ROW> | DTableBodyCellDatetimeOptions<ROW> | DTableBodyCellTimeOptions<ROW> | DTableBodyCellButtonOptions<ROW> | DTableBodyCellLinkOptions<ROW> | DTableBodyCellSelectMultipleOptions<ROW> | DTableBodyCellTreeOptions<ROW>;
export declare type DTableBodyCellOptionsMerged<ROW> = DTableBodyCellTextOptions<ROW> & DTableBodyCellInputTextOptions<ROW> & DTableBodyCellInputIntegerOptions<ROW> & DTableBodyCellInputRealOptions<ROW> & DTableBodyCellIndexOptions<ROW> & DTableBodyCellColorOptions<ROW> & DTableBodyCellCheckOptions<ROW> & DTableBodyCellSelectDialogOptions<ROW> & DTableBodyCellSelectPromiseOptions<ROW> & DTableBodyCellSelectMenuOptions<ROW> & DTableBodyCellDateOptions<ROW> & DTableBodyCellDatetimeOptions<ROW> & DTableBodyCellTimeOptions<ROW> & DTableBodyCellButtonOptions<ROW> & DTableBodyCellLinkOptions<ROW> & DTableBodyCellSelectMenuOptions<ROW> & DTableBodyCellTreeOptions<ROW>;
...
export interface DTableColumnSelectingOptions<CELL, DIALOG_VALUE, DIALOG extends DTableColumnSelectingDialog<DIALOG_VALUE>> {
...
export interface DTableColumnSelecting<CELL, DIALOG_VALUE, DIALOG extends DTableColumnSelectingDialog<DIALOG_VALUE>> {
    getter: DTableSelectingGetter<CELL, DIALOG>;
    setter: DTableSelectingSetter<CELL, DIALOG>;
    menu?: DMenu<CELL>;
    multiple?: DMenu<CELL>;
...
export interface DTableColumnOptions<ROW, CELL = any, DIALOG_VALUE = any, DIALOG extends DTableColumnSelectingDialog<DIALOG_VALUE> = any> {
    weight?: number;
    width?: number;
...
export interface DTableColumn<ROW, CELL = unknown, DIALOG_VALUE = unknown, DIALOG extends DTableColumnSelectingDialog<DIALOG_VALUE> = DTableColumnSelectingDialog<DIALOG_VALUE>> {
