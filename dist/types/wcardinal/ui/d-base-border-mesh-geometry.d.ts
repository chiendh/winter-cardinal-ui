...
export declare class DBaseBorderMeshGeometry extends MeshGeometry {
    ...
    constructor(texture: Texture, width: number, height: number, borderSize: number, borderMask: DBorderMask, cornerMask: DCornerMask);
    ...
    protected fillUvsCorner(iv: number, uvs: Float32Array, b1: boolean, b2: boolean, c: boolean, u0: number, u1: number, u2: number, u3: number, v0: number, v1: number, v2: number, v3: number): void;
    protected fillUvs(iv: number, uvs: Float32Array, b: boolean, u0: number, u1: number, v0: number, v1: number, uz: number, vz: number): void;
    update(): void;
}
